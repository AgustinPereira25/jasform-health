        ...
        <button
            ...
            className={tw(
                ...
                !disabled && [
                    ...
                    "bg-[#407EC9] text-white hover:bg-[#3c6597] transition-all ease-in-out duration-300",
                    variant === BUTTON_VARIANT.SECONDARY &&
                    "bg-transparent text-black hover:bg-gray-300 border-gray-400 transition-all ease-in-out duration-300",
                    ...
                    "font-normal text-white hover:text-white bg-[#FF8583] hover:bg-[#ae5352] transition-all ease-in-out duration-300",
                ],

                disabled && [
                    variant === BUTTON_VARIANT.PRIMARY && "bg-gray-300 text-gray-400 hover:bg-gray-300",
