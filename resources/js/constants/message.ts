export const message = {
  ...
  EMPTY_STATE: "No available data, try a different combination of filters.",
  EMPTY_STATE_ENTITY: "No available data, try a different ID or return.",
  SELECT_DATE: "No available data, please select a valid date.",
  ERROR_STATE:
